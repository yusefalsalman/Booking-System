      ...
      <div className="hotel-card p-6 sm:p-8 rounded-2xl sm:rounded-3xl">
        ...
        <div className="divide-y divide-stone-100">
          {rooms.map((room) => (
            <div
              key={room.id}
              className="py-4 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3 sm:gap-4 hover:bg-stone-50/75 px-3 rounded-xl transition"
            >
              <div className="flex items-center space-x-3 sm:space-x-4">
                ...
                <div>
                  <h4 className="text-sm sm:text-base font-bold text-stone-900">{room.name}</h4>
              ...
              <button
                ...
                className="w-full sm:w-auto text-xs bg-rose-50 hover:bg-rose-100 text-rose-700 hover:text-rose-800 border border-rose-200 px-3.5 py-2 rounded-xl transition duration-150 cursor-pointer font-semibold text-center"
              >
                Delete Suite
              </button>
            </div>
